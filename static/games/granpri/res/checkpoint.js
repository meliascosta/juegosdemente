...
function Checkpoint(trials,on_end,on_check){
	...
	$($chdiv).append("<div id=slider style=\"position: absolute; height: 100%; width: 5%; top: 0%; left: 0%;background-color: grey;\"></div>");
	for(i=0;i<=N;i++){
	$("#slider").append("<img id=\"checkimg"+i+"\" src=\""+IMG_URL+(i+1)+".png\" style=\" width:100%;height:100%;left:0%; \">")		
	}
