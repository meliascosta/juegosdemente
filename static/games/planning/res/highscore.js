...
function Highscore(new_game){
	...
	$("#htable").append("<tr style=\"background-color:red\"><td id=seguir style=\"cursor:pointer;cursor:hand;\"><p>SEGUIR</p></td><td id=\"exit\"><a href= \""+$.games.main_site+"\">SALIR</a></td></tr>");
